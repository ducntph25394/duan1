...
public class Menu extends javax.swing.JPanel {
    ...
    public Menu() {
        ...
        initData();
        if (DangNhap.ndLogin == null) {
            lblHoten.setText("Trống");
        } else {
            lblHoten.setText(DangNhap.ndLogin.getHoTen());
        }
    }

    private void initData() {
        listMenu.addItem(new Model_Menu("1", "Giao Dịch", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("2", "Sản phẩm", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("3", "Hóa đơn", Model_Menu.MenuType.MENU));
        ...
        listMenu.addItem(new Model_Menu("8", "Đổi mật khẩu", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("9", "Đăng xuất", Model_Menu.MenuType.MENU));
        listMenu.addItem(new Model_Menu("10", "Đóng ứng dụng", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new ImageIcon("src/main/icon/logo.png"));
        jLabel1.setText("Đồng hồ cao cấp");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblHoten, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblAVATAr, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(listMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                .addGap(18, 18, 18))
        );
